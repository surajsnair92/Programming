...
public class FlightExamples {
	...
	public static RacketList<Flight> simpleFlights = simpleFlights();

	public static RacketList<Flight> simpleTestFlights = simpleTestFlights();
	...
	private static RacketList<Flight> simpleTestFlights() {
		RacketList<Flight> fs00 = RacketLists.empty();
		RacketList<Flight> fs01
		= fs00.cons (flt ("Delta 01", "BOS", "ATL", 1210, 1310)); //1h
		RacketList<Flight> fs02
		= fs01.cons (flt ("Delta 02", "BOS", "ATL", 2010, 2109)); //59min
		RacketList<Flight> fs03
		= fs02.cons (flt ("Delta 03", "BOS", "MSP", 1510, 1530));  //20min
		RacketList<Flight> fs04
		= fs03.cons (flt ("Delta 04", "BOS", "MSP", 1520, 1541)); // 21min
		RacketList<Flight> fs05
		= fs04.cons (flt ("Delta 05", "ATL", "MSP", 1310, 1354)); //44min
		RacketList<Flight> fs06
		= fs05.cons (flt ("Delta 06", "ATL", "MSP", 1315, 1350)); //35min
		RacketList<Flight> fs07
		= fs06.cons (flt ("Delta 07", "MSP", "PDX", 1350, 1355)); //5min
		RacketList<Flight> fs08
		= fs07.cons (flt ("Delta 07", "PDX", "BOS", 1350, 1355)); //5min
